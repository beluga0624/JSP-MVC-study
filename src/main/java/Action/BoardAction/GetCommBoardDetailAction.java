...
import SVC.BoardSVC.GetCommBoardDetailService;
...
public class GetCommBoardDetailAction implements Action{

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		GetCommBoardDetailService getCommBoardDetailService = new GetCommBoardDetailService();
		...
		board = getCommBoardDetailService.getBoardDetail(boardNum, category, commCode, isCookieExist);
		fileList = getUploadedFilesService.getFileList(boardNum, category, commCode);
		...
		ActionForward forward = new ActionForward("/square/commBoardDetail.jsp", false);
