...
public class DeleteCommReplyAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		isDeleteSuccess = deleteReplyService.deleteReply(commCode, bno, category, rplNo);
		
		ActionForward forward = null;
		
		if(isDeleteSuccess) {
			forward = new ActionForward("/getCommBoardDetail.board?boardNum=" + bno + "&category=" + category + "&commCode=" + commCode, false);
		}else {
